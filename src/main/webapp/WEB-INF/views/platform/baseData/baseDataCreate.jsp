	...
	<script type="text/javascript">
		...
		var _success_callback = function (response) {
			...
			if (data.responseCode == 200) {
				$.openTip(data.responseMessage,true, function() {
					$.closeLoading();
					parent.window.location.href = ctx +'/platform/baseData/baseDataList.do';
		...
		var _saveForm = function () {
			$.openTip('确定保存吗？',false, function(){
        		...
        		jQuery.ajax({
            		type: "POST",
            		url: ctx + '/platform/baseDatabaseDataCreate.json',
		...
		<form class="form form-horizontal" id="formId">
			<div class="row cl">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入code" id="code" name="code">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入name" id="name" name="name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入val" id="val" name="val">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入enable" id="enable" name="enable">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入remark" id="remark" name="remark">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入sysParamsId" id="sysParamsId" name="sysParamsId">
				</div>
			</div>
