	...
	<script type="text/javascript">
		...
		var _success_callback = function (response) {
			...
			if (data.responseCode == 200) {
				$.openTip(data.responseMessage,true, function() {
					$.closeLoading();
					parent.window.location.href = ctx +'/platform/role/roleList.do';
		...
		var _saveForm = function () {
			$.openTip('确定保存吗？',false, function(){
        		...
        		jQuery.ajax({
            		type: "POST",
            		url: ctx + '/platform/roleroleCreate.json',
	...
	<article class="page-container">
		<form class="form form-horizontal" id="formId">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-9 col-sm-10">
					<input type="text" class="input-text" value="" placeholder="请输入frozen" id="frozen" name="frozen">
				</div>
			</div>
